        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">Controle completo de usuários do sistema</p>
            </div>
          </div>
        </div>
          ...
          <Card className="border-green-200 bg-white">
            <CardContent className="p-3 sm:p-4">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                <Badge className="bg-blue-100 text-blue-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1">Adm: {stats.byProfile.administrador}</Badge>
                <Badge className="bg-green-100 text-green-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1">Mon: {stats.byProfile.monitoria}</Badge>
                <Badge className="bg-indigo-100 text-indigo-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1">Mot: {stats.byProfile.motorista}</Badge>
                <Badge className="bg-purple-100 text-purple-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1">Dev: {stats.byProfile.desenvolvedor}</Badge>
                <Badge className="bg-emerald-100 text-emerald-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1">Fin: {stats.byProfile.financeiro}</Badge>
                <Badge className="bg-orange-100 text-orange-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1">Com: {stats.byProfile.comercial}</Badge>
                <Badge className="bg-pink-100 text-pink-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1">Ban: {stats.byProfile.banhista_tosador}</Badge>
              </div>
            </CardContent>
          </Card>
