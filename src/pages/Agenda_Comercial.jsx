      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs value={currentView} onValueChange={setCurrentView} className="w-full">
          <TabsList className="grid w-full grid-cols-4 lg:grid-cols-8 mb-6">
            <TabsTrigger value="day_care" className="flex items-center gap-1">
              <CalendarIcon className="w-4 h-4" />
              <span className="hidden sm:inline">Day Care</span>
            </TabsTrigger>
            <TabsTrigger value="hospedagem" className="flex items-center gap-1">
              <Home className="w-4 h-4" />
              <span className="hidden sm:inline">Hospedagem</span>
            </TabsTrigger>
            <TabsTrigger value="banho_tosa" className="flex items-center gap-1">
              <Scissors className="w-4 h-4" />
              <span className="hidden sm:inline">Banho & Tosa</span>
            </TabsTrigger>
            <TabsTrigger value="transporte" className="flex items-center gap-1">
              <Car className="w-4 h-4" />
              <span className="hidden sm:inline">Transporte</span>
            </TabsTrigger>
            <TabsTrigger value="adaptacao" className="flex items-center gap-1">
              <RefreshCw className="w-4 h-4" />
              <span className="hidden sm:inline">Adaptação</span>
            </TabsTrigger>
            <TabsTrigger value="visita" className="flex items-center gap-1">
              <Eye className="w-4 h-4" />
              <span className="hidden sm:inline">Visita</span>
            </TabsTrigger>
            <TabsTrigger value="adestramento" className="flex items-center gap-1">
